...
extern "C" {
    ...
    #[no_mangle]
    fn XGetErrorText(_: *mut Display, _: libc::c_int, _: *mut libc::c_char,
...
pub unsafe extern "C" fn send_xmessage(mut w: Window, mut a: Atom,
    ...
    let mut e: XClientMessageEvent =
        XClientMessageEvent{type_0: 0,
                            ...
                            message_type: 0,
                            format: 0,
                            data: C2RustUnnamed_0{b: [0; 20],},};
    e.type_0 = 33 as libc::c_int;
    e.window = w;
    e.message_type = a;
    e.format = 32 as libc::c_int;
    e.data.l[0 as libc::c_int as usize] = x;
    e.data.l[1 as libc::c_int as usize] = 0 as libc::c_long;
